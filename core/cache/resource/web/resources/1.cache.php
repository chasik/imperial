<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="upcontent">
    <div class="container_12">
        <div class="title-1">Добро пожаловать!</div>
        <h2>Мы рады видеть Вас на страницах нашего сайта!</h2>
        <div class="text-1">   Гостиничный комплекс «ИМПЕРИАЛ» – новая гостиница города Брянска, построенная в 2013 году. Наш отель <strong>ближайший от железнодорожного вокзала города Брянска (всего 300 метров)</strong> и находиться на берегу живописной реки Десна. Именно здесь вы найдёте отличные условия для проживания и по-европейски качественный сервис.<br />     У нас вы сможете найти всё, что необходимо для приятного время препровождения и отдыха, вам не придётся далеко идти или ехать. И это не все выгоды отличного месторасположения гостиничного комплекса «ИМПЕРИАЛ» - мы расположены на пересечении границ 3-х районов поэтому от нас легко добираться в каждый из них.</div>
        <h2>Мы будем рады видеть Вас в нашем отеле! Звоните круглосуточно: 8-(4832)-377-277</h2>
    </div>
    <div class="container_02">
        <h2 class="h2title">Всего 300 метров от железнодорожного вокзала города Брянска!</h2>
    </div>
    <script charset="utf-8" type="text/javascript" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=hDNRHVd1MJvk1DH_q6Ag_lJw_UY42M2d&amp;width=940&amp;height=450"></script>
    <div class="container_22"></div>
</div>',
    'richtext' => 0,
    'template' => 1,
    'menuindex' => 0,
				...
				<div id="block1">
					<nav>
						<!--ul class="up-menu">
							...
							<li><a href="virtualnyij-tur">Виртуальный тур</a></li>
...
<li class="last"><a href="contact-us" title="Контакты" >Контакты</a></li>
		...
		<div id="upslider">
			<h1>
				<a href="index.html">
					<img alt="Отель Империал" src="images/logoimperial.png">
				</a>
			</h1>
		</div>
                ...
                $(window).load(function(){
                    ...
                    $(\'nav > ul > li > a\').hover(
                        function(){
                            ...
                            TweenMax.to(this, 1, {textShadow: "0px 0px 0px #ffffff", color: "#b7aea6"});
                        }
                    );
                });
            </script>
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'name' => 'joinscripts',
          'description' => 'Подключаемые скрипты',
          'editor_type' => 0,
          'category' => 1,
          'cache_type' => 0,
...
',
      ...
      array (
        ...
        array (
          ...
          'source' => 1,
          'property_preprocess' => false,
          'name' => 'onloadpagescript',
          'description' => 'Скрипт события window onload',
          'editor_type' => 0,
          'category' => 1,
          'cache_type' => 0,
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'description' => 'Заголовок для seo оптимизации',
          'editor_type' => 0,
          'category' => 0,
          'locked' => false,
          'elements' => 'Отель "Империал"',
          'rank' => 0,
          'display' => 'default',
          'default_text' => 'Отель "Империал"',
          'properties' => 
          array (
          ),
          'input_properties' => 
