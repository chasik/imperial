<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '		<script type="text/javascript" src="pano2vr_player.js"></script>
		<script type="text/javascript" src="skin.js"></script>
		<div id="container" style="width:100%;height:500px;position:relative;top:-7px"></div>
		<script type="text/javascript">$(\'#container\').height($(window).outerHeight() - 365);</script>
		<script type="text/javascript">
			pano=new pano2vrPlayer("container");
			skin=new pano2vrSkin(pano);
			pano.readConfigUrl("imperial_out.xml");
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1427658755,
    'editedby' => 1,
    'editedon' => 1428295767,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1427660640,
    'publishedby' => 1,
    ...
    array (
      0 => 'seoTitle',
      1 => 'Виртуальный тур по отелю Империал',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html>
	<head>
		<title>Виртуальный тур по отелю Империал</title>
		<meta charset="utf-8">
		...
		<header>
				...
				<div id="block1">
					<nav>
						...
						<ul><li class="first"><a href="http://1001coders.ru/" title="Отель Империал г. Брянск" >Главная</a></li>
<li class="active"><a href="virtualnyij-tur" title="Виртуальный тур" >Виртуальный тур</a></li>
...
<li class="last"><a href="contact-us" title="Контакты" >Контакты</a></li>
		...
		<div id="sliderblock_inner"> 
			<img class="sliderimg" src="images/slider-0.jpg" />
		</div>
...
',
  ...
  'elementCache' => 
  array (
    '[[*seoTitle]]' => 'Виртуальный тур по отелю Империал',
    '[[$joinscripts]]' => '		<script type="text/javascript" src="/js/jquery-2.1.3.min.js"></script>
		<script type="text/javascript" src="/js/gsap_min/TweenMax.min.js"></script>
		<script type="text/javascript" src="/js/gsap_min/TimelineMax.min.js"></script>
		<script type="text/javascript" src="/js/gsap_min/EasePack.min.js"></script>
		<script type="text/javascript" src="/js/gsap_min/CSSPlugin.min.js"></script>',
    '[[Wayfinder? &startId=\'0\' &level=`1`]]' => '<ul><li class="first"><a href="http://1001coders.ru/" title="Отель Империал г. Брянск" >Главная</a></li>
<li class="active"><a href="virtualnyij-tur" title="Виртуальный тур" >Виртуальный тур</a></li>
<li><a href="nomera-i-ceny" title="Номера и цены" >Номера и цены</a></li>
<li><a href="bronirovanie" title="Бронирование номеров" >Бронирование</a></li>
<li><a href="services" title="Услуги" >Услуги</a></li>
